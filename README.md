...
- [DLL Injection Lab](https://github.com/bsmensah-ctrl/DLL-Injection-Lab) - Safe detection-testing harness that generates a deterministic five-event DLL-injection telemetry chain for correlation, parser, and pipeline validation, exporting JSON, Markdown, and SARIF without touching live processes.
