...
- [overruled | Mohib Shaikh](https://github.com/MohibShaikh/overruled) - A verdict auditor for AI agents that triage alerts. Replays security cases with known ground truth against any agent that speaks HTTP, then grades its rulings for correctness, fabricated evidence, missed evidence, consistency across runs, and alert parroting. No LLM participates in the grading; exit code 1 gates CI. Python, MIT.
