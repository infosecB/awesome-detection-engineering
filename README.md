...
- [Attack Mapper | Jose Argento](https://github.com/JoseArgento/attack-mapper) - An open-source CLI that maps Sigma detection rules onto the MITRE ATT&CK matrix (v19) to report detection coverage and gaps, with HTML/JSON/Navigator-layer output and a non-zero exit code for use as a Detection-as-Code CI gate.
