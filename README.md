...
- [MaGMa Detection Use Case Framework](https://www.betaalvereniging.nl/wp-content/uploads/FI-ISAC-use-case-framework-verkorte-versie.pdf) - Outlines a framework for formulating business-driven detection use cases.
...
- [Windows OS Event Logging Cheatsheets](https://www.malwarearchaeology.com/cheat-sheets)
...
- [Open Source Security Events Metadata (OSSEM)](https://github.com/OTRF/OSSEM) - open source project dedicated to standardizing security event logs and data sources.
