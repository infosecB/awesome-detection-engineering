...
- [Ridgeline Detection Library](https://github.com/ridgelinecyberdefence/Enterprise-Detection-Engineering) - Production-validated detections across nine platforms (KQL, Sigma, Splunk, Athena, PowerShell, Velociraptor, YARA, Suricata, osquery), each with triggers, false positives, tuning guidance, and validation steps. Apache-2.0.
